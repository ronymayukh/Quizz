...
public class StudentRegistration {
    ...
    public void Registration(ActionEvent actionEvent) throws Exception {
        if(checkInputs()){
            ...
            Integer response = DBcalls.StudentRegistration(tfRegNo.getText(),tfName.getText(),tfPassword.getText());
            ...
            if(response == 1){
                ...
                if(alert.getResult() == ButtonType.OK){
                    ...
                    Parent studentLoginPage = FXMLLoader.load(getClass().getResource("StudentLogin.fxml"));
